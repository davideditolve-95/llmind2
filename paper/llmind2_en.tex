...
Automatic metrics may include top-1 accuracy, top-k accuracy, precision, recall, and F1 when a gold standard is available. For richer textual responses, semantic measures and manual rubrics must be added. Measuring ``no diagnosis'' answers is important because it distinguishes assertive errors from abstention. Response time and retrieval cost should be measured as secondary variables rather than primary objectives.
